...
export const ENCOUNTERS = {
  ...
  pond: {
    ...
    steps: [
      ...
      { say: "No, you're not crazy. You are absolutely stunning. Crazy face card AND body tea. Put some respect where it's due!", who: "guide" },
      { memory: { id: "pond", photos: [{ src: P(1), caption: "the cutest girl to ever live" }] } },
  ...
  insurance: {
    ...
    steps: [
      ...
      { say: "You've got a weakness. Someone figured it out early: if he ever needed a *yes* out of you... he'd just show up with a sweet treat. Even better if it was homemade. Shameless bribery.", who: "guide" },
      ...
      { say: "Nothing beats seeing you enjoy yourself. Eat up! We've got lots more exploring to do.", who: "guide" },
      { gate: "g2" },
    ],
  },
  ...
  firstDate: {
    ...
    steps: [
      ...
      { memory: { id: "firstDate", photos: [{ src: P(4), caption: "the first date — june 28, 2025" }] } },
  ...
  falling: {
    ...
    steps: [
      ...
      { say: "Yeah, he was a little strange. He randomly sent me a picture of his burrito bowl...", who: "memory" },
      ...
      { memory: { id: "falling", photos: [{ src: P(5), caption: "fireworks into forever – july 23, 2025" }] } },
  ...
  family: {
    ...
    steps: [
      ...
      { say: "And you made room. You brought him into all of it. You even pulled him closer to his *own* family. He is a better son and brother himself now, because of you. Your love is multiplied many times over.", who: "guide" },
      { memory: { id: "family", photos: [{ src: P(7), caption: "everyone you hold" }] } },
      { say: "Whatever you become, wherever you go, you carry them all with you. And they carry you. He knows how lucky he is to be on that list.", who: "guide" },
    ],
  },
  ...
  notices: {
    ...
    steps: [
      ...
      { say: "He has never, in his whole life, felt as loved as you make him feel. For exactly who he is. Flaws and all. Do you know what that *is*, to a person? To be seen fully, and kept anyway?", who: "guide" },
      { memory: { id: "notices", photos: [{ src: P(11), caption: "the one who notices" }] } },
      { say: "You gave him that. Every day. And he's spent this little journey trying to give a little of it back to you.", who: "guide" },
      { gate: "g4" },
    ],
  },
